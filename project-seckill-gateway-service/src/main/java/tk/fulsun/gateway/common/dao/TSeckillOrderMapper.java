...
import tk.fulsun.gateway.common.dao.dataobject.TSeckillOrderExample;
...
public interface TSeckillOrderMapper {
    ...
    int updateByExampleSelective(@Param("record") TSeckillOrder record, @Param("example") TSeckillOrderExample example);

    int updateByExample(@Param("record") TSeckillOrder record, @Param("example") TSeckillOrderExample example);
