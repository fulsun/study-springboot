...
public class TSeckillProduct implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getProdStatus() == null ? other.getProdStatus() == null : this.getProdStatus().equals(other.getProdStatus()))
            && (this.getProdStock() == null ? other.getProdStock() == null : this.getProdStock().equals(other.getProdStock()))
