...
public interface TSeckillProductMapper {
    ...
    int updateByExampleSelective(@Param("record") TSeckillProduct record, @Param("example") TSeckillProductExample example);

    int updateByExample(@Param("record") TSeckillProduct record, @Param("example") TSeckillProductExample example);
