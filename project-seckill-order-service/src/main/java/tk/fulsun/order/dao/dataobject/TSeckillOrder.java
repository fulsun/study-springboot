  ...
  public boolean equals(Object that) {
    ...
    return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
        ...
        && (this.getRecordStatus() == null
            ? other.getRecordStatus() == null
            : this.getRecordStatus().equals(other.getRecordStatus()))
        ...
        && (this.getUserPhoneno() == null
            ? other.getUserPhoneno() == null
            : this.getUserPhoneno().equals(other.getUserPhoneno()))
        && (this.getProdId() == null
        ...
        && (this.getChargeMoney() == null
            ? other.getChargeMoney() == null
            : this.getChargeMoney().equals(other.getChargeMoney()))
        && (this.getChargeTime() == null
            ? other.getChargeTime() == null
            : this.getChargeTime().equals(other.getChargeTime()))
        && (this.getFinishTime() == null
            ? other.getFinishTime() == null
